...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { artist: @calendar.artist, eventDate: @calendar.eventDate, links: @calendar.links }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { artist: @calendar.artist, eventDate: @calendar.eventDate, links: @calendar.links }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
